...
<div class='card border'>
    <div class='card-body'>
        ...
        <table class='table table-ordered table-hover' id='table'>
            <thead>
                <tr>
                    <th>id</th><th>created_at</th><th>updated_at</th><th>nome</th><th>funcao</th><th>id_acesso</th><th>senha</th>
                </tr>
            </thead>
            <tbody >
...
'<td>'+ v.id +'</td>'+'<td>'+ v.created_at +'</td>'+'<td>'+ v.updated_at +'</td>'+'<td>'+ v.nome +'</td>'+'<td>'+ v.funcao +'</td>'+'<td>'+ v.id_acesso +'</td>'+'<td>'+ v.senha +'</td>'+
